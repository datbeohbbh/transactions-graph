...
func (x *VertexRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VertexRequest) ProtoMessage() {}

func (x *VertexRequest) ProtoReflect() protoreflect.Message {
	mi := &file_graph_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VertexRequest.ProtoReflect.Descriptor instead.
func (*VertexRequest) Descriptor() ([]byte, []int) {
	return file_graph_proto_rawDescGZIP(), []int{2}
}

func (x *VertexRequest) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
var file_graph_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x73, 0x22, 0x29, 0x0a, 0x0d, 0x56, 0x65, 0x72, 0x74, 0x65, 0x78, 0x52, 0x65, 0x71,
	...
	,
}
...
var file_graph_proto_goTypes = []interface{}{
	...
	(*VertexRequest)(nil),       // 2: graph.VertexRequest
	(*Empty)(nil),               // 3: graph.Empty
	(*timestamp.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_graph_proto_depIdxs = []int32{
	4, // 0: graph.Vertex.createdAt:type_name -> google.protobuf.Timestamp
	4, // 1: graph.Vertex.updatedAt:type_name -> google.protobuf.Timestamp
	0, // 2: graph.Vertices.vertices:type_name -> graph.Vertex
	3, // 3: graph.GraphData.GetAllVertex:input_type -> graph.Empty
	2, // 4: graph.GraphData.GetVertexByAddress:input_type -> graph.VertexRequest
	1, // 5: graph.GraphData.GetAllVertex:output_type -> graph.Vertices
	0, // 6: graph.GraphData.GetVertexByAddress:output_type -> graph.Vertex
